...
public class Nom { //Не забудь очистить в конце ветки способов значение Nom.sposobInt
    ...
    public static boolean boolOpisSp4 = false;
    public static boolean boolOpisSp5 = false;
    public static ImageView tekMem;
    public static int sposobInt;
    public static boolean predGolosa = false;
    public static int vvod = 2;
}
